...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**⌔︙ اهلا وسهلا بك  {mention} **\
                        \n**⌔︙ {my_mention}'انا البوت المساعد .**\
                        \n**⌔︙ يمكنك التواصل مع صاحب البوت فقط ارسل رسالتك 👤.**\
                        \n\n**⌔︙ البوت خاص بسورس :** [sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx](https://t.me/YY_VP)"
        buttons = [
            (
                Button.url("تنصيب سورسنا", "https://heroku.com/deploy?template=https://github.com/MTK-Q/HHHH"),
                Button.url(
                    "قناه المساعد",
                    "https://t.me/yzzzy",
                ),
