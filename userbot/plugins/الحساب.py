...
digitalpfp = gvarstatus("AUTO_PIC") or "https://telegra.ph/file/b3b23298a17af7a120d0b.jpg"
NAME_OK = "**☸ ⦙  تم تغيير اسم حسابك بنجاح  ✅**"
USERNAME_SUCCESS = "**☸ ⦙  تم تغيير معرّف حسابك بنجاح  ✅**"
USERNAME_TAKEN = "**☸ ⦙  هذا المعرّف مستخدم  ❌**"
plugin_category = "tools"
DEFAULTUSERBIO = gvarstatus("DEFAULT_BIO") or "(@YY_VP) الحمد الله علي كل حال "
...
async def fetch_info(replied_user, event):
    ...
    rozrtba = (
        ".「  مبرمج سورس ماتركس 🇪🇬   」."
        if user_id == 5246153486 or user_id == 2059448162 or user_id == 2025149451
        else (".「  العضـو  」.")
    )  
    rozrtba = (
        ".「  رٍحٍقٌلُِبَ آسلُِآم 💞🌍   」."
    ...
    caption += "<b>𓆩ⵧⵧⵧⵧ⁦⁦sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx ⵧⵧⵧⵧ𓆪</b>\n"
